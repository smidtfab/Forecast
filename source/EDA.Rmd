...
Read the in ../lib/TS_Constructor.Rmd constructed data
```{r}
D.US.orig <- read.table('../data/USEPUINDXD.csv', header=TRUE,sep=',')
D.CH.orig <- read.table('../data/CHIEPUINDXM.csv', header=TRUE,sep=',')

D.US <- read.table('../data/delta_epu_us.csv', header=TRUE)
D.CH <- read.table('../data/delta_epu_ch.csv', header=TRUE)
```
